...
export default function Home() {
  ...
  const fetchNews = useCallback(
    async (pageNum: number, append: boolean, currentFilters: NewsFilters) => {
      if (append) {
      ...
      try {
        ...
        const errorMessage =
          error.message || "There was a problem fetching news articles.";
    ...
    <div className="flex flex-col h-screen overflow-hidden bg-background">
          ...
          <Sheet open={isMobileSheetOpen} onOpenChange={setIsMobileSheetOpen}>
            ...
            <SheetContent side="left" className="w-72 p-0">
              <SheetHeader className="p-6 pb-0">
                ...
                <SheetDescription>
                  Refine your news feed by searching, and selecting categories
                  or sources.
                </SheetDescription>
              </SheetHeader>
              <ScrollArea className="h-full">
                <div className="p-6 pt-4">{filterPanel}</div>
              </ScrollArea>
            </SheetContent>
          </Sheet>
        </div>
      ...
      <div className="flex flex-1 overflow-hidden">
        <aside className="hidden w-72 border-r md:block bg-card">
          <ScrollArea className="h-full">{filterPanel}</ScrollArea>
        </aside>
